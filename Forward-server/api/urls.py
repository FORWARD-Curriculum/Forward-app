...
from .views import UserRegistrationView, SessionView, CurrentUserView, QuizView, LessonView, LessonContentView, TextContentView, WritingView, PollView, UserDataView, GetLessonIds
...
urlpatterns = [
    ...
    path('lessons/<str:id>', LessonView.as_view(), name='lessons'), #need to change the int to str
