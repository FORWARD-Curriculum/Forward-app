...
from .views import UserRegistrationView, SessionView, CurrentUserView, QuizView, CurriculumView, LessonView, LessonContentView, TextContentView, WritingView, PollView
...
urlpatterns = [
    ...
    path('lessons/<int:id>', LessonView.as_view(), name='lessons-id'),
