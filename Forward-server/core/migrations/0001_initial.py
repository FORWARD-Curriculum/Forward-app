# Generated by Django 5.2 on 2025-09-29 21:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partial_response', models.BooleanField(default=False, help_text='Whether the quiz has been completed and submitted')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('associated_activity', models.ForeignKey(help_text='The quiz that was answered', on_delete=django.db.models.deletion.CASCADE, related_name='user_responses', to='core.quiz')),
