# Generated by Django 5.2 on 2025-12-01 01:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructions_image_height', models.PositiveIntegerField(blank=True, editable=False, null=True)),
                ('instructions_image_ppoi', models.CharField(default='0.5x0.5', max_length=20)),
                ('image', models.ImageField(blank=True, height_field='image_height', upload_to='public/fillintheblank/images/', width_field='image_width')),
        ...
        migrations.CreateModel(
            name='JSONImageModel',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, help_text='the uuid of the database item, stored in the json image field', primary_key=True, serialize=False)),
                ('image', models.ImageField(blank=True, height_field='image_height', upload_to='public/jsonimagemodel/', width_field='image_width')),
                ('image_width', models.PositiveIntegerField(blank=True, editable=False, null=True)),
                ('image_height', models.PositiveIntegerField(blank=True, editable=False, null=True)),
                ('image_ppoi', models.CharField(default='0.5x0.5', max_length=20)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order', models.PositiveIntegerField(help_text='Order within the concept map')),
                ('title', models.CharField(help_text='The title of the concept')),
                ('image', models.ImageField(height_field='image_height', help_text='An image representing the concept.', upload_to='public/concept/', width_field='image_width')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, height_field='image_height', help_text='Optional image to represent the lesson in the dashboard', upload_to='public/lesson/', width_field='image_width')),
                ('image_width', models.PositiveIntegerField(blank=True, editable=False, null=True)),
                ('image_height', models.PositiveIntegerField(blank=True, editable=False, null=True)),
                ('image_ppoi', models.CharField(default='0.5x0.5', max_length=20)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructions_image_height', models.PositiveIntegerField(blank=True, editable=False, null=True)),
                ('instructions_image_ppoi', models.CharField(default='0.5x0.5', max_length=20)),
                ('image', models.ImageField(blank=True, height_field='image_height', help_text='Optional Image to accompany the Quiz', upload_to='public/quiz/', width_field='image_width')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, height_field='image_height', help_text='Optional image to accompany the Question', upload_to='public/question/', width_field='image_width')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, help_text='the uuid of the database item', primary_key=True, serialize=False)),
                ('content', martor.models.MartorField(default='')),
                ('image', models.ImageField(blank=True, height_field='image_height', upload_to='public/slideshow/slides/images', width_field='image_width')),
                ('order', models.PositiveIntegerField(default=0)),
                ('image_width', models.PositiveIntegerField(blank=True, editable=False, null=True)),
                ('image_height', models.PositiveIntegerField(blank=True, editable=False, null=True)),
                ('image_ppoi', models.CharField(default='0.5x0.5', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, height_field='image_height', help_text='Optional image to accompany the text content', upload_to='public/textcontent/', width_field='image_width')),
                ('image_width', models.PositiveIntegerField(blank=True, editable=False, null=True)),
                ('image_height', models.PositiveIntegerField(blank=True, editable=False, null=True)),
                ('image_ppoi', models.CharField(default='0.5x0.5', max_length=20)),
                ('lesson', models.ForeignKey(help_text='The lesson this activity belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_activities', to='core.lesson')),
