        ...
        <div className={`max-w-6xl mx-auto px-6 py-5 text-secondary-foreground ${user?.preferences?.text_size || ""}`}>
            ...
            <div className="border-t border-muted pt-8">
                <MarkdownTTS controlsClassName="flex flex-row-reverse items-start justify-between gap-4">
                    ...
                    <p className="mb-4 text-base">You'll work through fun, interactive lessons about real-life topics. The lessons are built with your needs in mind, including:</p>
            ...
            <div className="border-t border-muted pt-8 mt-8">
                <MarkdownTTS controlsClassName="flex flex-row-reverse items-start justify-between gap-4">
                    ...
                    <p className="mb-4 text-base">There are <strong>five lessons</strong> in FORWARD right now:</p>
